...
class GoogleSheetsMapper {
    ...
    static {
        sheetMap.put(9999L, new SheetInfo("1AAeZoCS3K1sFiJqaeuYDktUL-xf2omBXIxs-_ZzfcRg", "tally!A:F"));
        sheetMap.put(8888L, new SheetInfo("1AAeZoCS3K1sFiJqaeuYDktUL-xf2omBXIxs-_ZzfcRg", "tally!A:F"));
